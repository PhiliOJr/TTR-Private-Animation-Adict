...
4219: (ToontownBattleGlobals.SOUND_TRACK, 5, 55, 4),
4115: (ToontownBattleGlobals.SOUND_TRACK, 5, 35, 3),
...
3137: (ToontownBattleGlobals.NPC_COGS_MISS, 0, 2, 3),
4327: (ToontownBattleGlobals.NPC_COGS_MISS, 0, 3, 4),
4230: (ToontownBattleGlobals.NPC_COGS_MISS, 0, 4, 5),
3135: (ToontownBattleGlobals.NPC_TOONS_HIT, 0, 2, 3),
5124: (ToontownBattleGlobals.NPC_TOONS_HIT, 0, 3, 4),
2208: (ToontownBattleGlobals.NPC_TOONS_HIT, 0, 4, 5),
...
def getNPCTrackHpRarity(npcId):
    if npcId in npcFriends:
        track, level, hp, rarity = npcFriends[npcId]
        return (track, hp, rarity)
    return (None, None)
